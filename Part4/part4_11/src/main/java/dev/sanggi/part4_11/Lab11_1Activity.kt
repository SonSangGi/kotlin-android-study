...
import kotlinx.android.synthetic.main.activity_lab11_1.*

class Lab11_1Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val html = "<font color='red'>얼레지</font> <br/> <img src='img1'/><br/>곰배령에서 만난 봄꽃"
        htmlView.text = Html.fromHtml(html, Html.ImageGetter { source ->
            if (source.equals("img1")) {
                var dr = ResourcesCompat.getDrawable(resources, R.drawable.img2, null)
                dr!!.setBounds(0, 0, dr.intrinsicWidth, dr.intrinsicHeight)
                dr
            } else null
        }, null)
